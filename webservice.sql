...
--
-- Struttura della tabella `enabledcountry`
--

CREATE TABLE IF NOT EXISTS `enabledcountry` (
  `id` int(11) NOT NULL,
...
INSERT INTO `enabledcountry` (`id`, `countryCode`, `countryName`) VALUES
(1, 'IT', 'Italia'),
(2, 'US', 'America');
...
CREATE TABLE IF NOT EXISTS `timeline` (
  ...
  `updatedAt` varchar(26) NOT NULL,
  `death` int(12) NOT NULL,
  `confirmed` int(12) NOT NULL,
  `recovered` int(12) NOT NULL,
  `new_confirmed` int(12) NOT NULL,
  `new_recovered` int(12) NOT NULL,
  `new_deaths` int(12) NOT NULL,
...
--
-- Indici per le tabelle `enabledcountry`
--
